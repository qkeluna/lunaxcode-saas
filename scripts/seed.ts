    ...
    const featuresData = [
      {
        ...
        description: 'AI-powered planning means your website goes from idea to launch in just 2-4 weeks. No lengthy delays or endless meetings.',
        icon: 'Clock',
        category: 'core',
        order: 1,
        isActive: true,
      ...
      },
      {
        ...
        description: 'Pay with GCash, Maya, or credit card. Choose milestone payments or installments that fit your budget.',
        icon: 'CreditCard',
        category: 'business',
        order: 3,
        isActive: true,
      ...
      {
        title: '24/7 Project Dashboard',
        description: 'Watch your website come to life in real-time. Check progress, view updates, and message your team anytime, anywhere.',
        icon: 'BarChart3',
        category: 'core',
        order: 4,
        isActive: true,
      ...
      },
      {
        ...
        description: 'Your website loads in under 2 seconds on any device. Fast sites mean happy customers and better Google rankings.',
        icon: 'Zap',
        category: 'technical',
        order: 5,
        isActive: true,
